  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(
        `https://wttr.in/${encodeURIComponent(searchQuery)}?format=j1`
      );
      ...
      const parsed: WeatherData = {
        ...
        current: {
          ...
          windspeedMiles: Number.parseInt(
            data.current_condition[0].windspeedMiles
          ),
      ...
      {!isLoading && weatherData && (
        <>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-semibold">
                        {weatherData.current.windspeedMiles} mph
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-semibold">
                        {(weatherData.current.pressure / 33.864).toFixed(2)} in
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          <section className="max-w-7xl mx-auto px-4 pb-12">
            <h3 className="text-2xl font-semibold mb-6">Next Day</h3>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-1">
                        <p className="text-lg font-semibold">
                          {getTemp(day.maxtempC, day.maxtempF)}°
                        </p>
                        <p className="text-sm text-muted-foreground">
                          {getTemp(day.mintempC, day.mintempF)}°
                        </p>
                      </div>
                    </CardContent>
                  </Card>
